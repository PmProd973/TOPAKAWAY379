    ...
    <Paper elevation={0} sx={{ p: 2, height: '100%', overflow: 'auto' }}>
      ...
      {!useNewConstructionSystem ? (
        ...
        <>
          ...
          {/* PLINTHES - Modification: utiliser updateConstructionV2 direct au lieu de debouncedUpdateConstructionV2 */}
          <Box sx={{ mb: 4 }}>
            <Typography variant="subtitle1" sx={{ mb: 2, fontWeight: 'bold' }}>
              Plinthes
            </Typography>
            ...
            <Box sx={{ mb: 3, p: 2, border: '1px solid #ddd', borderRadius: 1 }}>
              ...
              {constructionV2.base.frontPlinth?.enabled && (
                <>
                  <Grid container spacing={2} sx={{ mt: 2 }}>
                    <Grid item xs={6}>
                      <TextField
                        ...
                        label="Hauteur"
                        type="number"
                        value={constructionV2.base.baseHeight}
                        onChange={(e) => {
                          e.stopPropagation();
                  ...
                  <Typography variant="body2" sx={{ mt: 2, mb: 1 }}>Retraits</Typography>
                  <Grid container spacing={2}>
                    <Grid item xs={6}>
                      <TextField
                        fullWidth
          ...
          <Box sx={{ mb: 4 }}>
            ...
            <Box sx={{ mb: 3, p: 2, border: '1px solid #ddd', borderRadius: 1 }}>
              <FormControlLabel
                control={
                  <Checkbox
                    checked={constructionV2.cladding.top.enabled}
                    onChange={(e) => {
                      e.stopPropagation();
                      toggleCladding('top', e.target.checked);
                    }}
                  />
                }
              ...
              {constructionV2.cladding.top.enabled && (
                <>
                  <Grid container spacing={2} sx={{ mt: 2 }}>
                    <Grid item xs={6}>
                      <TextField
